...
--
-- Name: elements name_uniq; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements sym_uniq; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT sym_uniq UNIQUE (symbol);
...
--
-- Name: properties atom_num; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT atom_num FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties type_connect; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT type_connect FOREIGN KEY (type_id) REFERENCES public.types(type_id);
